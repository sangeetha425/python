...
list1=[34,'apple',12,'cat',1,'ball']
list1.sort()
print(list1) #not supported between instances of 'str' and 'int

list1=['apple','ball','elephant','cat']
list1.sort()
print(list1)
...
list1=[[13,24,1,2],[34,3,4,5],[1,6,8]]
list1.sort(key=lambda l1:l1[0])
print(list1)   #this both are printed by  using lambda function.

list1=[[13,24,1,2],[34,3,4,5],[1,6,8]]
list1.sort(key=lambda l1:l1[0], reverse=True)
print(list1)
